...
class GroceryRVAdapter(
    ...
    val groceryItemClickInteface: MainActivity
) :
    RecyclerView.Adapter<GroceryRVAdapter.GroceryViewHolder>() {

    inner class GroceryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val nameTV = itemView.findViewById<TextView>(R.id.idTVItem)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GroceryViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.grocery_iv_item, parent, false)
    ...
    override fun onBindViewHolder(holder: GroceryViewHolder, position: Int) {
        ...
        holder.amountTV.text = "Sh. " + itemTotal.toString()
        holder.deleteTV.setOnClickListener {
            groceryItemClickInteface.onItemClick(list.get(position))
        }
    }
